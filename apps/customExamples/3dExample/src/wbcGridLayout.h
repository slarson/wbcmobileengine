...
#ifndef WBC_GRIDLAYOUT
#define WBC_GRIDLAYOUT
...
public:
	...
	int			mPadding;
	int			mSideLength;
	int			mGridSpacingPixels;
	float		mGridSpacingPercentage;
	
	float		mScale;
	
	ofxPoint2f  mPosition;
	ofxPoint2f  mSize;
	
	bool		bUseAbsoluteSpacing;
	
	ofxPoint2f	getPositionForIndex(int _index);
	ofxPoint2f	getSize();
	
	void		setLayout(ofxPoint2f _position, ofxPoint2f _size); 
	void		adjustScale(float _scale);
