...
//#pragma mark cinder
//	inline ofxQuaternion( const ofxVec3f &from, const ofxVec3f &to ) { set( from, to ); }
//	
//	inline void set( const ofxVec3f &from, const ofxVec3f &to )
//	{
//		ofxVec3f axis = from.cross( to );
//		
//		set( from.dot( to ), axis[0], axis[1], axis[2] );
//		normalize();
//		
//		_v[0] += 1.0;
//		
...
//				set( 0.0 ,  0.0 , from[2], -from[1] );
//			}
//			else {
//				set( 0.0, from[1], -from[0], 0.0 );
//			}
//		}
//		
//		normalize();
...
//			v = Vec3<T>( 0, 0, 0 );
	...
	inline ofxQuaternion normalized() const
	{
		ofxQuaternion result = *this;
