...
{	 
	...
	position	= ofxPoint2f(320.0f, 240.0f);
	...
	{	
		...
		panel3->addXYPad(kParameter_Position, "position", 110, 82, ofxPoint2f(0.0f, 0.0f), ofxPoint2f(640.0f, 480.0f), position, kofxGui_Display_Int, 0);
		panel3->addPoints(kParameter_Points1, "points1", 110, 82, ofxPoint2f(0.0f, 0.0f), ofxPoint2f(640.0f, 480.0f), position, kofxGui_Display_Int, 0);
		panel3->addSlider(kParameter_Speed1, "speed1", 110, OFXGUI_SLIDER_HEIGHT, 0.0f, 0.01f, speed1, kofxGui_Display_Float4, 0);
		panel3->addPoints(kParameter_Points2, "points2", 110, 82, ofxPoint2f(0.0f, 0.0f), ofxPoint2f(360.0f, 360.0f), ofxPoint2f(180.0f, 180.0f), kofxGui_Display_Int, 0);
